...
frequecy_feature = [f for f in df_train.columns if ("_freq" in f) or ("_pse" in f)]
cluster_feature = ["cluster"]

print("Basic features: ",len(basic_feature))
print('Square features: ',len(square_feature))
print('PCA features: ',len(pca_feature))
print('Time features: ',len(time_feature))
print('Frequency features: ',len(frequecy_feature))
print('Cluster features: ',len(cluster_feature))

feature_set_1 = list(set(basic_feature))
feature_set_2 = list(set(basic_feature + square_feature + pca_feature))
feature_set_3 = list(set(feature_set_2 + time_feature))
feature_set_4 = list(set(feature_set_3 + frequecy_feature + cluster_feature))
